...
class WindowController(
    ...
    internal val rawState = WindowState(
        ...
        initialBoundsProvider = WindowBoundsProvider(
            positionProvider = when (position) {
                ...
                is WindowPosition.Aligned -> WindowPositionProvider.AlignedToScreenAvailableBounds(position.alignment)
                is WindowPosition.PlatformDefault -> WindowPositionProvider.AlignedToScreenAvailableBounds(Alignment.Center)
            },
     ...
     * 设置窗口最小化状态
     */
    var minimize: Boolean get() = rawState.isInitialized && rawState.isMinimized
