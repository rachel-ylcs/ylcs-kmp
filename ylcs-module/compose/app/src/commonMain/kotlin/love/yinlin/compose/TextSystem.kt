...
val DefaultTextSystem = TextSystem(
    ...
    headlineLarge = ModeText(true, 28, 30, 32),
    headlineMedium = ModeText(true, 24, 26, 28),
    headlineSmall = ModeText(true, 20, 22, 24),
    titleLarge = ModeText(true, 17, 18, 19),
    titleMedium = ModeText(true, 15, 16, 17),
    titleSmall = ModeText(true, 13, 14, 15),
    bodyLarge = ModeText(true, 16, 17, 18),
    bodyMedium = ModeText(true, 14, 15, 16),
    bodySmall = ModeText(true, 12, 13, 14),
