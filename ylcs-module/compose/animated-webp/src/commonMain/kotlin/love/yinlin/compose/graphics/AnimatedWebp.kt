...
@Stable
abstract class AnimatedWebp(val width: Int, val height: Int, val frameCount: Int) : AutoCloseable {
    companion object {
        internal fun check(data: ByteArray): Boolean {
...
expect fun ByteArray.decodeAnimatedWebp(): AnimatedWebp?