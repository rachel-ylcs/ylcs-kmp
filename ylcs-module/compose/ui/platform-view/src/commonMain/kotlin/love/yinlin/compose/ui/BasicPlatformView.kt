...
abstract class BasicPlatformView<T : Any> {
    ...
    private val hostLock = SynchronizedObject()

    protected fun hostFactory(builder: () -> T): T = synchronized(hostLock) {
    ...
    @Suppress("UNCHECKED_CAST")
    protected fun hostRelease(view: T) = synchronized(hostLock) {
