...
@NativeLib
class PAGFile internal constructor(constructor: () -> Long) : PAGComposition(PAGFile::nativeRelease, constructor) {
    companion object {
        init {
    ...
    fun getEditableIndices(layerType: Int): IntArray = nativeGetEditableIndices(nativeHandle, layerType)
