...
import love.yinlin.extension.uint2
 ...
 * 回收站是否为空
 */
val isRecycleBinEmpty: Boolean get() = memScoped {
 ...
 * 回收站是否非空
 */
val isRecycleBinNotEmpty: Boolean get() = !isRecycleBinEmpty

/**
 * 清空回收站
 */
fun clearRecycleBin(tip: Boolean = false) {
