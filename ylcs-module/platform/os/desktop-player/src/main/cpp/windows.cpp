...
extern "C" {
    ...
    JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
        ...
        // Init Audio Player
        jclass clz1 = env->FindClass("love/yinlin/platform/WindowsNativeAudioPlayer");
        ...
        // Init Video Player
        jclass clz2 = env->FindClass("love/yinlin/platform/WindowsNativeVideoPlayer");
        ...
        g_method_nativeVideoSourceChange = env->GetMethodID(clz2, "nativeSourceChange", "()V");
        ...
        g_method_nativeVideoFrameAvailable = env->GetMethodID(clz2, "nativeVideoFrameAvailable", "(II[B)V");
