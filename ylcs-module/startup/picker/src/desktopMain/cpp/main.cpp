...
extern "C" {
	...
	JNIEXPORT jstring JNICALL Java_love_yinlin_startup_NativePicker_openFileDialog(
		JNIEnv* env,
		jobject,
		jlong parent,
		jstring title,
	...
	JNIEXPORT jobjectArray JNICALL Java_love_yinlin_startup_NativePicker_openMultipleFileDialog(
		JNIEnv* env,
		jobject,
		jlong parent,
		jint maxNum,
	...
	JNIEXPORT jstring JNICALL Java_love_yinlin_startup_NativePicker_saveFileDialog(
		JNIEnv* env,
		jobject,
		jlong parent,
		jstring title,
