            ...
            when (node) {
                is TextNode -> {
                    ...
                    if (text.startsWith('#') && text.endsWith('#')) { // # 话题
                        ...
                        list.topic(WeiboUrl.searchTopic(topic), text)
                    }
                ...
                is ANode -> {
                    ...
                    if (children.size == 1 && text != null) {
                        if (href.startsWith("/n/")) list.at(WeiboUrl.href(href), text) // @ 标签
                        else if (href.startsWith("/status/")) list.link(WeiboUrl.href(href), text)
