...
actual typealias PlatformRenderEffect = RenderEffect

actual typealias PlatformColorFilter = ColorFilter

@RequiresApi(31)
actual fun createShaderRenderEffect(
  shader: Shader,
  crop: Rect?,
...
@RequiresApi(31)
actual inline fun PlatformRenderEffect.then(other: PlatformRenderEffect): PlatformRenderEffect {
  return RenderEffect.createChainEffect(other, this)
}

@RequiresApi(31)
actual fun PlatformRenderEffect.asComposeRenderEffect(): androidx.compose.ui.graphics.RenderEffect {
