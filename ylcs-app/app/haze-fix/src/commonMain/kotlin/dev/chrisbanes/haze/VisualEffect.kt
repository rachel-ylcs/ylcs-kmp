...
interface VisualEffect {
   ...
   */
  fun detach(context: VisualEffectContext): Unit = Unit
   ...
   */
  fun onTrimMemory(context: VisualEffectContext, level: TrimMemoryLevel): Unit = Unit
   ...
   * capabilities.
   */
  fun shouldDrawContentBehind(context: VisualEffectContext): Boolean = false

  /**
   * Returns whether the effect output should be clipped to the node bounds.
   */
  fun shouldClipToNodeBounds(): Boolean = false

  /**
   * Returns whether the effect prefers to clip to area bounds.
   */
  fun shouldPreferClipToAreaBounds(): Boolean = false
