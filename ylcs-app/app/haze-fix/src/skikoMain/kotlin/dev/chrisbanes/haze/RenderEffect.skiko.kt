...
actual fun createRuntimeEffect(sksl: String): PlatformRuntimeEffect {
...
actual fun createBlendRenderEffect(
...
actual fun createColorFilterRenderEffect(
...
actual fun createBlurRenderEffect(
  radiusX: Float,
  radiusY: Float,
  tileMode: TileMode,
  input: PlatformRenderEffect?,
...
actual fun createOffsetRenderEffect(
  offsetX: Float,
  offsetY: Float,
  input: PlatformRenderEffect?,
  crop: Rect?,
...
actual fun PlatformRenderEffect.then(other: PlatformRenderEffect): PlatformRenderEffect {
  return ImageFilter.makeCompose(other, this)
}

actual fun PlatformRenderEffect.asComposeRenderEffect(): RenderEffect {
...
actual fun isRuntimeShaderRenderEffectSupported(): Boolean = true

actual fun createRuntimeShaderRenderEffect(
