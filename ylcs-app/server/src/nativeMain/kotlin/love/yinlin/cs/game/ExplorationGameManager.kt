...
import love.yinlin.cs.FailureException
...
// 探索
abstract class ExplorationGameManager(mysql: MysqlService) : GameManager(mysql) {
    ...
    override suspend fun preflight(uid: Int, details: GameDetails): PreflightResult {
        // 检查重试记录
        val oldRecord = mysql.querySQLSingle("""
    ...
    override suspend fun QueryExecutor.updateRecord(record: GameRecord, answer: JsonElement, result: GameResult) {
