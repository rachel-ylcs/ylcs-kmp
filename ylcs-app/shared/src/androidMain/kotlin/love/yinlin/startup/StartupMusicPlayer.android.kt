    ...
    override suspend fun initController(context: Context) {
        Coroutines.main {
            ...
            val mediaController = Coroutines.io {
                val sessionToken = SessionToken(androidContext, ComponentName("love.yinlin", "love.yinlin.MusicService"))
        ...
        .setMediaMetadata(
            MediaMetadata.Builder()
                ...
                .setArtworkUri(Fixup.updateLocalFileProviderPermission(
                    ...
                    authority = androidContext.getString(love.yinlin.shared.R.string.mod_file_provider),
